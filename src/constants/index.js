...
export const myProjects = [
  {
    ...
    spotlight: `${import.meta.env.BASE_URL}assets/spotlight1.webp`,
    tags: [
      {
        id: 1,
        name: 'React.js',
      ...
      },
      {
        id: 3,
        name: 'TypeScript',
        path: `${import.meta.env.BASE_URL}assets/vite.svg`,
      },
      {
        id: 4,
        name: 'Framer Motion',
  ...
  },
  {
    ...
    spotlight: `${import.meta.env.BASE_URL}assets/spotlight2.webp`,
    tags: [
      {
        id: 1,
        name: 'React.js',
  ...
  },
  {
    ...
    spotlight: `${import.meta.env.BASE_URL}assets/spotlight3.webp`,
    tags: [
      {
        id: 1,
        name: 'React.js',
  ...
  },
  {
    ...
    spotlight: `${import.meta.env.BASE_URL}assets/spotlight4.webp`,
    tags: [
      {
        id: 1,
        name: 'React.js',
  ...
  },
  {
    ...
    spotlight: `${import.meta.env.BASE_URL}assets/spotlight5.webp`,
    tags: [
      {
        id: 1,
        name: 'React.js',
...
export const calculateSizes = (isSmall, isMobile, isTablet, isExtraLarge) => {
  const getDeskPosition = () => {
    if (isMobile) return [0.25, -2.5, 0];
    if (isTablet) return [0.5, -3.5, 0];
    return [0.25, -3.5, 0];
  };
